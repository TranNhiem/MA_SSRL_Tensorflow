...
def read_cfg_base(mod="non_contrastive"):
    ...
    FLAGS.wandb_run_name = "Res-18_RandCrop_SimCLR_AutoAugment_V1_100CLS"
    ...
    FLAGS.model_dir = "/data/multi_augment_project/resnet_byol/18_RandCrop_SimCLR_AutoAugment_V1_100CLS"
    #FLAGS.train_mode = "finetune"

    # ds ratio 
    FLAGS.tra_ds_ratio = 40
    FLAGS.subset_percentage = 1
