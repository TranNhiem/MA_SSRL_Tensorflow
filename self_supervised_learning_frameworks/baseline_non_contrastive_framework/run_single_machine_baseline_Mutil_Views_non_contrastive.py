...
def main(FLAGS):
    ...
    @tf.function
    def distributed_train_step(ds_1, ds_2, ds_3, ds_4, ds_5):
        per_replica_losses = strategy.run(
            train_step, args=(ds_1, ds_2, ds_3, ds_4, ds_5))

        return strategy.reduce(tf.distribute.ReduceOp.SUM, per_replica_losses,
                               axis=None)

    @tf.function
    def train_step(ds_1, ds_2, ds_3, ds_4, ds_5):
        # This design for Multiview-Dataset with (Supervised Label)
        """Noted  Design Under development"""
        images_one, lable_one = ds_1
        images_two, lable_two = ds_2
        image_3, _ = ds_3
        image_4, _ = ds_4
        image_5, _ = ds_5
    ...
    if "train" in FLAGS.mode:
        ...
        with strategy.scope():
            ...
            for epoch in trange(FLAGS.train_epochs):
                ...
                for _, (ds_1, ds_2, ds_3, ds_4, ds_5) in enumerate(train_ds):
