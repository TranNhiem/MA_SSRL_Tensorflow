...
def read_cfg_base(mod="non_contrastive"):
    ...
    FLAGS.wandb_run_name = "Res-18_RandCropt_mixed_Augment_100CLS_300eps"
    ...
    FLAGS.model_dir = "./multi_augment_project/resnet_byol/18_RandCropt_mixed_Augment_100CLS_300eps"
