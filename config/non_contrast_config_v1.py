...
def read_cfg_base(mod="non_contrastive"):
    ...
    FLAGS.wandb_run_name = "Res-18_RandCroptSimCLR_Augment_100CLS"
    ...
    FLAGS.model_dir = "/data/multi_augment_project/resnet_byol/Res-18_RandCroptSimCLR_Augment_100CLS"
